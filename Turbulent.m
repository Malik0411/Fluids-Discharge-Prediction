...
ylabel('Velocity, [m/s]');
xlabel('Time, [s]');
title('Velocity vs time (Turbulent)'); % creates a title for the plot
...
ylabel('Position, [m]');
xlabel('Time, [s]');
title('Position vs time (Turbulent)'); % creates a title for the plot
...
ylabel('Re');
xlabel('Time, [s]');
title('Re vs time (Turbulent)'); % creates a title for the plot
...
ylabel('hf');
xlabel('Time, [s]');
title('hf vs time (Turbulent)'); % creates a title for the plot
...
ylabel('Velocity, [m/s]');
xlabel('Position, [m]');
title('Velocity vs Position (Turbulent)'); % creates a title for the plot